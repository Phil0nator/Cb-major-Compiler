...
section .data
    STRING_CONSTANT_0: db `Give me a string: `, 0
nullterm: DB 0
true: DB 1
false: DB 0
...
mov rdi, rbx
mov rax, 0
call _char._getString_pchar.
push rax
;[[ fn(x) : [ function char. getString( [[ Variable: char. msg @ 0]] ) ] ]]
;------------
pop rax
mov QWORD[rbp-24], rax
;[[ id : strtest]]
