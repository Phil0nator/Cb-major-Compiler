...
STRING_CONSTANT_143: db `This is a string %s, and this is an int : %i\n`, 0
STRING_CONSTANT_144: db `STRINGSTRINGSTRING`, 0
...
.L0x96:
	...
	mov rax, rdi
	dec rsi
	jz .L0x99_int_pow_pintint_end
.L0x99_int_pow_pintint_flp:
	mul rdi
	dec rsi
	jnz .L0x99_int_pow_pintint_flp
.L0x99_int_pow_pintint_end:
.L0x98:
	mov dword[rbp-64], eax
	mov ebx, dword[rbp-64]
	mov r10, qword[rbp-32]
