...
_long_log2_plong:
	xor rax, rax
.L0x289_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x289_long_lop2_plong_flp
	dec rax
	ret
...
.L0xe5avxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xe5avxmemzeraligned_lp
	ret
