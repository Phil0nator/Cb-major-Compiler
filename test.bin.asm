...
mov r8, 10
    ...
    mov rax, r9
___int_firstDigit_pint__return:
leave
ret
_void_toStr_pintchar.:
push rbp
mov rbp, rsp
sub rsp, 32
mov [rbp-8], rdi
...
_LWHILEEND_0x50:
___void_toStr_pintchar.__return:
leave
ret
