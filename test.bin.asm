...
STRING_CONSTANT_165: db `Final Check: %i, %f, %s, %c\n`, 0
FLT_CONSTANT_4: dq 0x1.73b780346dc5dp+4
STRING_CONSTANT_166: db `this is twenty three`, 0
...
main:
	...
	mov [rbp-8], rdi
	mov r8b, 50
	mov rcx, STRING_CONSTANT_166
	mov rdx, qword[FLT_CONSTANT_4]
	mov rsi, 23
