...
_long_log2_plong:
	...
	sub rsp, 8
	xor rax, rax
.L0x209_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x209_long_lop2_plong_flp
	dec rax
...
.L0xc1avxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xc1avxmemzeraligned_lp
...
_int_getA_pTest:
	...
	mov rbx, qword[rbx]
	mov eax, ebx
	jmp ___int_getA_pTest__return
___int_getA_pTest__return:
	leave
	ret
main:
	push rbp
