...
.L0xd3:
	...
	mov dword[rbp-135], ebx
	jmp .L0xd5
.L0xd4:
	mov ecx, dword[rbp-135]
	mov rbx, qword[rbp-16]
	mov eax, ecx
	cdqe
	lea rcx, [rbx+rax*1]
	mov r10d, dword[rbp-135]
	mov rbx, qword[rbp-119]
	movsxd r11, r10d
	sub rbx, r11
...
.L0xad:
	...
	jmp .L0xaf
.L0xae:
	mov ecx, dword[rbp-45]
	lea rbx, [rbp-37+rcx*1]
	mov rcx, rdi
	mov cl, byte[rcx]
	mov [rbx], cl
	sub dword[rbp-45], 1
...
.L0xb0:
	...
	add rbx, r10
	inc rbx
	mov qword[rbp-53], rbx
	mov qword[rbp-61], 0
	mov qword[rbp-69], 1
	mov dword[rbp-77], 0
	jmp .L0xb2
.L0xb1:
	mov ecx, dword[rbp-77]
	mov rbx, qword[rbp-53]
	mov eax, ecx
	cdqe
	mov cl, [rbx+rax*1]
	movsx eax, cl
	cdqe
	mov rbx, rax
	mov dword[rbp-85], ebx
	mov ebx, dword[rbp-85]
	sub ebx, 48
	mov rax, qword[rbp-69]
	movsxd rcx, ebx
	imul rcx, rax
	add qword[rbp-61], rcx
	mov rbx, 10
	mov rax, qword[rbp-69]
	imul rax, rbx
	mov rcx, rax
	mov qword[rbp-69], rcx
.L0xb3:
	add dword[rbp-77], 1
.L0xb2:
	mov ecx, dword[rbp-45]
	...
	movsxd r10, ecx
	sub rbx, r10
	cmp dword[rbp-77], ebx
	jl .L0xb1
.L0xb4:
	mov rbx, qword[rbp-8]
	mov rax, qword[rbp-61]
	imul rax, rbx
___long_stoi_pchar.__return:
	leave
	ret
...
.L0xfc:
	...
	mov r10, qword[rbp-8]
	mov rdi, r10
	movsd xmm7, qword[rbp-200]
	movsd xmm0, xmm7
	call _long_toStr_pdoublechar.long
	mov r10, rax
	mov dword[rbp-208], r10d
...
.L0xfd:
	...
	mov r10, [rcx+rax*8]
	movq xmm7, r10
	movss dword[rbp-216], xmm7
	cvtss2sd xmm7, dword[rbp-216]
	movsd qword[rbp-224], xmm7
	mov rsi, 10000000
	mov r10, qword[rbp-8]
	mov rdi, r10
	movsd xmm7, qword[rbp-224]
	movsd xmm0, xmm7
	call _long_toStr_pdoublechar.long
	mov r10, rax
	mov dword[rbp-232], r10d
	mov ecx, dword[rbp-232]
	movsxd r10, ecx
	dec r10
	add qword[rbp-8], r10
	jmp .L0xef
...
.L0xff:
	cmp byte[rbp-248], 52
	jne .L0x101
	mov dword[rbp-256], 32
	add qword[rbp-16], 1
	jmp .L0x102
.L0x101:
	cmp byte[rbp-248], 50
	jne .L0x103
	mov dword[rbp-256], 16
	add qword[rbp-16], 1
	jmp .L0x104
.L0x103:
	cmp byte[rbp-248], 49
...
.L0x1bdavxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0x1bdavxmemzeraligned_lp
