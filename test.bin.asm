...
LC.S168: db `%b\n`, 0
LC.S169: db `/bin/bash`, 0
LC.S170: db `PATH=/bin:/usr/bin:/sbin:/usr/sbin`, 0
LC.S171: db `sudo`, 0
LC.S172: db `-c`, 0
LC.S173: db `LOCKED`, 0
LC.S174: db `Enter an integer: `, 0
LC.S175: db `123456`, 0
LC.S176: db `%i`, 0
LC.S177: db `You entered: %i`, 0
...
__emptyenv: DQ LC.S170, 0, 0
__systemcallargvconst: DQ LC.S171, LC.S172, 0, 0
