...
STRING_CONSTANT_133: db `0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ`, 0
STRING_CONSTANT_134: db `False`, 0
STRING_CONSTANT_135: db `True`, 0
STRING_CONSTANT_136: db `%s`, 0
...
__format_numchars: DQ STRING_CONSTANT_133
rand_next: DQ 1
section .bss
align 16
