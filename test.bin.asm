...
LC.S171: db `%f\n`, 0
LC.S172: db `%l\n`, 0
LC.F30: dq 0x1.4000000000000p+1
LC.S173: db `123hd0.5: \t %i%s%f`, 0
LC.S174: db `hd`, 0
LC.F31: dq 0x1.0000000000000p-1
...
_long_log2_plong:
	xor rax, rax
.L0x263_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x263_long_lop2_plong_flp
	dec rax
	ret
...
.L0xe3avxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xe3avxmemzeraligned_lp
	ret
...
_void_thread_join_pthread_t.:
	...
	ret
main:
	cvttsd2si rdi, qword[LC.F30]
	call _void_print_plong
	xor rax, rax
__main__return:
	ret
_void_print_plong:
