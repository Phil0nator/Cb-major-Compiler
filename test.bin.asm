...
__LC.S173: db `%i, `, 0
__LC.S174: db `%i]\n`, 0
__LC.S175: db `Failed: %l/%l != %l, but %l`, 0
__LC.S176: db `127.0.0.1`, 0
__LC.S177: db `Lost connection to host.`, 0
__LC.S178: db `123hd0.5: \t %i%s%f`, 0
__LC.S179: db `hd`, 0
	section .bss align=8
__tmbuf: resb 36
__internaltime: resb 8
	...
	global main
_Vec3f._.operator24_punique_ptrVec3f.:
	mov rbx, qword[rdi+0]
	vmovdqu ymm0, [rbx+32]
	movq rax, xmm0
___Vec3f._.operator24_punique_ptrVec3f.__return:
	ret
_Vec3f._.operator25_punique_ptrVec3f.:
	mov rbx, qword[rdi+0]
	mov rax, rbx
___Vec3f._.operator25_punique_ptrVec3f.__return:
	ret
_Vec3f._.operator2_punique_ptrVec3f.size_t:
	mov rbx, qword[rdi+0]
	shl rsi, 5
	lea r10, [rbx+rsi]
	vmovdqu ymm0, [r10+32]
	movq rax, xmm0
___Vec3f._.operator2_punique_ptrVec3f.size_t__return:
	ret
_void__Dunique_ptr_punique_ptr.:
	push rdi
	mov rdi, qword[rdi+0]
	...
	mov rbx, rax
	xor rax, rax
___void__Dunique_ptr_punique_ptr.__return:
	ret
_void__Cunique_ptr_punique_ptr.Vec3f.:
	mov r10, rsi
	mov qword[rdi+0], r10
	xor rax, rax
___void__Cunique_ptr_punique_ptr.Vec3f.__return:
	ret
...
.L0x2e9:
	...
	mov rsi, rax
	lea rdi, [rbp-24]
	call _void__Cunique_ptr_punique_ptr.Vec3f.
	lea rdi, [rbp-56]
...
__main__return:
	push rax
	lea rdi, [rbp-24]
	call _void__Dunique_ptr_punique_ptr.
	lea rdi, [rbp-56]
