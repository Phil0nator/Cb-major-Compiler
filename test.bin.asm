...
_long_log2_plong:
	xor rax, rax
.L0x25d_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x25d_long_lop2_plong_flp
	dec rax
	ret
...
.L0xddavxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xddavxmemzeraligned_lp
	ret
...
_void_thread_join_pthread_t.:
	...
	leave
	ret
_void__CTwoer_pTwoerint:
	mov r10d, esi
	mov dword[rdi+0], r10d
	xor rax, rax
	ret
_int_operator3_pTwoerint:
	add esi, esi
	add dword[rdi+0], esi
	mov ebx, dword[rdi+0]
	mov eax, ebx
___int_operator3_pTwoerint__return:
	ret
main:
	push rbp
	mov rbp, rsp
