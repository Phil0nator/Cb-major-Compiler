...
FLT_CONSTANT_30: dq 0x1.4000000000000p+1
FLT_CONSTANT_31: dq 0x1.ccccccccccccdp+1
STRING_CONSTANT_174: db `%f\n`, 0
STRING_CONSTANT_175: db `%i\n`, 0
...
_long_log2_plong:
	...
	sub rsp, 8
	xor rax, rax
.L0x200_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x200_long_lop2_plong_flp
	dec rax
...
.L0xb8avxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xb8avxmemzeraligned_lp
...
main:
	...
	mov rax, rbx
.L0x1:
	movsd xmm7, qword[FLT_CONSTANT_31]
	movsd xmm1, xmm7
	movsd xmm7, qword[FLT_CONSTANT_30]
	movsd xmm0, xmm7
	movsd xmm8, xmm1
	movsd xmm7, xmm0
	addsd xmm7, xmm8
