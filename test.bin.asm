...
STRING_CONSTANT_3: db `This is a thing %i\n`, 0
nullptr: DQ 0
null: DQ 0
nullterm: DQ 0
M_MINZERO_MEM: DQ 0
...
leave
ret
_int_call25times_pvoid.voidvoid:
push rbp
mov rbp, rsp
sub rsp, 40
mov [rbp-8], rdi
...
.L0x51:
mov rax, 0
jmp ___int_call25times_pvoid.voidvoid__return
___int_call25times_pvoid.voidvoid__return:
leave
ret
main:
push rbp
...
mov [rbp-16], rsi
mov rdx, QWORD[rbp-8]
mov rsi, STRING_CONSTANT_3
mov rbx, printf
mov rdi, rbx
xor rax, rax
call _int_call25times_pvoid.voidvoid
push rax
mov rax, 5
jmp __main__return
__main__return:
