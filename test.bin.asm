...
STRING_CONSTANT_139: db `Here...\n`, 0
STRING_CONSTANT_140: db `False`, 0
STRING_CONSTANT_141: db `True`, 0
STRING_CONSTANT_142: db `/bin/bash`, 0
STRING_CONSTANT_143: db `PATH=/bin:/usr/bin:/sbin:/usr/sbin`, 0
STRING_CONSTANT_144: db `sudo`, 0
STRING_CONSTANT_145: db `-c`, 0
STRING_CONSTANT_146: db `%s:%i: Assertion '%s' failed.\n`, 0
STRING_CONSTANT_147: db `=======================\n`, 0
STRING_CONSTANT_148: db `EMPTY\n`, 0
STRING_CONSTANT_149: db `BLOCK: %i @ %x : %i\n`, 0
STRING_CONSTANT_150: db `Appends: %i, Deletions %i, Cache: %u\n`, 0
STRING_CONSTANT_151: db `=======================\n`, 0
FLT_CONSTANT_28: dq 0x1.6d40000000000p+8
FLT_CONSTANT_29: dq 0x1.6d40000000000p+8
STRING_CONSTANT_152: db `Sun`, 0
STRING_CONSTANT_153: db `Mon`, 0
STRING_CONSTANT_154: db `Tue`, 0
STRING_CONSTANT_155: db `Wed`, 0
STRING_CONSTANT_156: db `Thu`, 0
STRING_CONSTANT_157: db `Fri`, 0
STRING_CONSTANT_158: db `Sat`, 0
STRING_CONSTANT_159: db `Jan`, 0
STRING_CONSTANT_160: db `Feb`, 0
STRING_CONSTANT_161: db `Mar`, 0
STRING_CONSTANT_162: db `Apr`, 0
STRING_CONSTANT_163: db `May`, 0
STRING_CONSTANT_164: db `Jun`, 0
STRING_CONSTANT_165: db `Jul`, 0
STRING_CONSTANT_166: db `Aug`, 0
STRING_CONSTANT_167: db `Sep`, 0
STRING_CONSTANT_168: db `Oct`, 0
STRING_CONSTANT_169: db `Nov`, 0
STRING_CONSTANT_170: db `Dec`, 0
STRING_CONSTANT_171: db `%i `, 0
STRING_CONSTANT_172: db `%i:%i:%i %i`, 0
STRING_CONSTANT_173: db `%i.%i.%i.%i`, 0
STRING_CONSTANT_174: db `LOCKED`, 0
STRING_CONSTANT_175: db `unlocked thread: %i\n`, 0
...
__emptyenv: DQ STRING_CONSTANT_143, 0, 0
__systemcallargvconst: DQ STRING_CONSTANT_144, STRING_CONSTANT_145, 0, 0
...
wday_name: DQ STRING_CONSTANT_152, STRING_CONSTANT_153, STRING_CONSTANT_154, STRING_CONSTANT_155, STRING_CONSTANT_156, STRING_CONSTANT_157, STRING_CONSTANT_158
mon_name: DQ STRING_CONSTANT_159, STRING_CONSTANT_160, STRING_CONSTANT_161, STRING_CONSTANT_162, STRING_CONSTANT_163, STRING_CONSTANT_164, STRING_CONSTANT_165, STRING_CONSTANT_166, STRING_CONSTANT_167, STRING_CONSTANT_168, STRING_CONSTANT_169, STRING_CONSTANT_170
...
_long_log2_plong:
	...
	sub rsp, 8
	xor rax, rax
.L0x1e6_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x1e6_long_lop2_plong_flp
	dec rax
