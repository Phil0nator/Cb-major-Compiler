...
_long_log2_plong:
	...
	sub rsp, 8
	xor rax, rax
.L0x1f7_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x1f7_long_lop2_plong_flp
	dec rax
...
.L0xafavxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xafavxmemzeraligned_lp
...
__main__return:
	leave
	ret
_void_static_cast_plong:
	push rbp
	mov rbp, rsp
	sub rsp, 8
	mov rax, rdi
	jmp ___void_static_cast_plong__return
___void_static_cast_plong__return:
	leave
	ret
