...
_Testint._bruh_pint:
	...
	lea rbx, [rbp-12]
	mov rax, rbx
	jmp ___Testint._bruh_pint__return
___Testint._bruh_pint__return:
	leave
	ret
_Testdouble._bruh_pdouble:
	push rbp
	mov rbp, rsp
	sub rsp, 16
	mov qword[rbp-16], 0
	movsd xmm8, xmm0
	movsd qword[rbp-16], xmm8
	lea rbx, [rbp-16]
	mov rax, rbx
	jmp ___Testdouble._bruh_pdouble__return
___Testdouble._bruh_pdouble__return:
	leave
	ret
main:
	push rbp
...
.L0x1:
	...
	movsd xmm0, xmm7
	call _Testdouble._bruh_pdouble
