...
M_MINZERO_MEM: dq 0
	...
	global main
_int._.operator24_ppointerint.:
	mov rbx, qword[rdi+0]
	mov rax, rbx
___int._.operator24_ppointerint.__return:
	ret
_int._.operator32_ppointerint.int.:
	mov qword[rdi+0], rsi
	mov rbx, qword[rdi+0]
	mov rax, rbx
___int._.operator32_ppointerint.int.__return:
	ret
_int._.operator25_ppointerint.:
	mov rbx, qword[rdi+0]
	mov rax, rbx
___int._.operator25_ppointerint.__return:
	ret
_void__Dpointer_ppointer:
	push rdi
	mov rdi, qword[rdi+0]
...
_int_test_ppointerint:
	...
	mov rbx, qword[rbx]
	mov eax, ebx
___int_test_ppointerint__return:
	leave
	ret
main:
	push rbp
