...
FLT_CONSTANT_2: dq 0x1.c000000000000p+1
FLT_CONSTANT_3: dq 0x1.599999999999ap+2
FLT_CONSTANT_4: dq 0x1.d99999999999ap+2
FLT_CONSTANT_5: dq 0x1.0000000000000p+0
FLT_CONSTANT_6: dq 0x1.4cccccccccccdp+1
FLT_CONSTANT_7: dq 0x1.dd70a3d70a3d7p+2
...
clone_threadflags: DQ 0
__tsigfutex: DQ 0
arr1: DQ 0x1.4000000000000p+1, 0x1.c000000000000p+1, 0x1.599999999999ap+2, 0x1.d99999999999ap+2
arr2: DQ 0x1.0000000000000p+0, 0x1.4cccccccccccdp+1, 0x1.4000000000000p+2, 0x1.dd70a3d70a3d7p+2
	section .bss
	align 16
...
.L0x9d:
	...
	mov rax, rdi
	dec rsi
	jz .L0xa0_int_pow_pintint_end
.L0xa0_int_pow_pintint_flp:
	mul rdi
	dec rsi
	jnz .L0xa0_int_pow_pintint_flp
.L0xa0_int_pow_pintint_end:
.L0x9f:
	mov dword[rbp-64], eax
	mov ebx, dword[rbp-64]
	mov r10, qword[rbp-32]
...
.L0xe9:
	...
	jmp .L0xe7
.L0xe7:
	jmp ___long_thread_join_pthread_t__return
___long_thread_join_pthread_t__return:
	leave
	ret
main:
	push rbp
