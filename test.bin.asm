...
STRING_CONSTANT_165: db `This will be faster! %i, %f\n`, 0
FLT_CONSTANT_4: dq 0x1.759999999999ap+4
...
_long_log2_plong:
	...
	mov [rbp-8], rdi
	xor rax, rax
.L0x1a_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x1a_long_lop2_plong_flp
	dec rax
