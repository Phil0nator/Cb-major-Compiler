...
STRING_CONSTANT_133: db `%d\n`, 0
STRING_CONSTANT_134: db `%d\n`, 0
...
.L0x3:
	...
	push rax
	movsd xmm0, xmm8
	call _long_static_cast_pdouble
	mov rbx, rax
	pop rax
	movq xmm8, rax
	mov rax, rbx
...
_long_static_cast_pdouble:
	...
	movq rbx, xmm7
	mov rax, rbx
	jmp ___long_static_cast_pdouble__return
___long_static_cast_pdouble__return:
	leave
	ret
