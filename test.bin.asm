...
LC.S166: db `%i.%i.%i.%i`, 0
LC.S167: db `/bin/bash`, 0
LC.S168: db `PATH=/bin:/usr/bin:/sbin:/usr/sbin`, 0
LC.S169: db `sudo`, 0
LC.S170: db `-c`, 0
LC.S171: db `LOCKED`, 0
...
__emptyenv: DQ LC.S168, 0, 0
__systemcallargvconst: DQ LC.S169, LC.S170, 0, 0
...
_long_log2_plong:
	xor rax, rax
.L0x246_long_lop2_plong_flp:
	sar rdi, 1
	inc rax
	test rdi, rdi
	jnz .L0x246_long_lop2_plong_flp
	dec rax
	ret
...
.L0xedavxmemzeraligned_lp:
	vmovdqu [rdi], ymm0
	add rdi, 4
	sub rsi, 4
	jnz .L0xedavxmemzeraligned_lp
	ret
