...
__LC.S175: db `%l: %l\n`, 0
__LC.S176: db `%i\n`, 0
__LC.S177: db `127.0.0.1`, 0
__LC.S178: db `Lost connection to host.`, 0
__LC.S179: db `123hd0.5: \t %i%s%f`, 0
__LC.S180: db `hd`, 0
	section .bss align=8
__tmbuf: resb 36
...
.L0xbf:
	...
	mov rcx, __numbercharactersbase1016
	mov r11b, [rcx+r10*1]
	mov [rbx], r11b
	add qword[rbp-119], 1
.L0xc0:
...
_int_inet_aton_pchar.in_addr.:
	...
	mov r12d, 255
	mov r11d, dword[rbp-59]
	and r11d, r12d
	mov r12d, dword[rbp-35]
	sal r12d, 24
	mov r13d, dword[rbp-43]
	sal r13d, 16
	or r12d, r13d
	mov r13d, dword[rbp-51]
	sal r13d, 8
	or r12d, r13d
	mov r13d, dword[rbp-59]
	or r13d, r12d
	mov edi, r13d
	xor rax,rax
	bswap edi
